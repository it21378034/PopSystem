            ...
            {saved ? (
              ...
              <>
                ...
                <textarea
                  ...
                  rows={2}
                  className="w-full bg-slate-50 border border-slate-200 rounded-lg p-2 text-xs focus:outline-none focus:ring-1 focus:ring-teal-600 resize-none text-slate-700 placeholder-slate-400 print:hidden"
                />
