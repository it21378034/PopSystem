...
export default function Quotations() {
  ...
  const handleDelete = (quotNo) => {
    if (!window.confirm(`Delete quotation ${quotNo}? This cannot be undone.`)) return;
    const updated = quotations.filter(q => q.quotNo !== quotNo);
                  ...
                  <tr key={quot.quotNo} className="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors duration-150">
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          onClick={() => handleDelete(quot.quotNo)}
